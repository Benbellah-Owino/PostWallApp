...
const { likePost, getMyPosts, getOriginalPoster, deletePost, getSingleUserPost, post, comment, getAllPosts, getPost, getMedia, checkForLike } = require("../controllers/posts")
