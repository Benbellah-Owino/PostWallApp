...
const { likePost, getMyPosts, getOriginalPoster, getReplies, deletePost, getSingleUserPost, post, comment, getAllPosts, getPost, getMedia, checkForLike } = require("../controllers/posts")
